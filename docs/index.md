...
* **A caching backend**. For example, using Vercel KV may improve the performance of our [with-routes middleware](./middleware).
...
* **Evaluating middleware**. Assess the costs and benefits of the [default Catalyst middleware](./middleware). You may tailor the middleware for your use case or remove it altogether.
