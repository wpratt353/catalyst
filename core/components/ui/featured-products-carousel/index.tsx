...
export const FeaturedProductsCarousel = function FeaturedProductsCarousel({
  ...
  return (
    <section className="@container">
      <div className="text-foreground mx-auto flex w-full max-w-screen-2xl flex-row flex-wrap justify-between gap-5 px-3 pt-10 @xl:px-6 @4xl:items-end @4xl:pt-20 @5xl:px-20">
