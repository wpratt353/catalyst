  ...
  return (
    ...
    >
      <div
        ...
        ref={ref}
      >
        <nav className="relative grid h-[60px] grid-cols-[1fr,auto,1fr] items-center justify-between bg-background shadow-[2px_4px_24px_#00000010] @4xl:mx-5 @4xl:rounded-3xl">
          {/* Top Level Nav Links */}
          ...
          >
            {typeof logo === 'object' && logo.src ? (
              <Image alt={logo.altText} fill sizes="400px" src={logo.src} />
            ) : (
              typeof logo === 'string' && (
